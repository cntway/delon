import { Component, Input, TemplateRef, ContentChild, OnInit, OnChanges, Inject, Optional, SimpleChange, SimpleChanges } from '@angular/core';
...
@Component({
    ...
    `,
    host: { '[class.ad-page-header]': 'true' },
