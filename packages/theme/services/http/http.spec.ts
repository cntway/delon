...
import { ALAIN_THEME_OPTIONS, AlainThemeOptions } from '../../index';
    ...
    describe('[property]', () => {
        ...
        describe('[get]', () => {
            ...
            it('should be catch error', (done: () => void) => {
                ...
                backend.expectOne(req => req.method === 'GET' && req.url === URL).flush(null, { status: 500, statusText: 'Server Error' });
            });
        });
        ...
        describe('[jsonp]', () => {
            ...
            it(`specified params and url include ?`, (done: () => void) => {
                ...
                const ret = backend.expectOne(req => req.method === 'JSONP' && req.url.startsWith(u)) as TestRequest;
            ...
            it('should be catch error', (done: () => void) => {
                ...
                backend.expectOne(req => req.method === 'JSONP' && req.url.startsWith(URL)).flush(null, { status: 500, statusText: 'Server Error' });
            });
        });
